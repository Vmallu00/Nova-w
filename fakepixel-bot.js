...
class FakePixelBot extends EventEmitter {
  ...
  attachMinecraftListeners(bot) {
    ...
    bot.on(
      ...
      message => {
        ...
        /*
         * IMPORTANT:
         * Do not flood the panel with
         * FakePixel action-bar updates.
         */
        if (
  ...
  /* ================================================
   * MAIN SPAWN / SKYBLOCK HUB DETECTION
   * ================================================ */
  ...
  async handleMainSpawn() {
    ...
    if (
      ...
      this.log(
        `Main spawn detected. Distance: ${mainDistance.toFixed(2)}`
      );
     ...
     *
     * If the bot is already around:
     *
     * -2.500 / 70.06250 / -68.000
     *
     * it immediately goes to /visit.
     */
    ...
    if (
      ...
      this.log(
        `SkyBlock Hub detected at ${position.x.toFixed(2)}, ${position.y.toFixed(2)}, ${position.z.toFixed(2)}.`
      );
    ...
    if (
      ...
      this.log(
        `Waiting for spawn/hub. Main: ${mainDistance.toFixed(2)} | Hub: ${hubDistance.toFixed(2)}`
      );
    }
  ...
  async handleVisiting() {
    ...
    try {
      ...
      this.log(
        `Clicking target island: visible slot 12 / Mineflayer slot ${visitSlot}.`
      );
